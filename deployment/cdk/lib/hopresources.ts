...
import { IBucket, Bucket, BlockPublicAccess, ObjectOwnership } from 'aws-cdk-lib/aws-s3';
...
export class HopResourcesNestedStack extends cdk.NestedStack {
  ...
  constructor(scope: Construct, id: string, props?: cdk.StackProps) {
    ...
    this.s3Bucket = new Bucket(this,`${project}-samples`, {blockPublicAccess:BlockPublicAccess.BLOCK_ALL, objectOwnership:ObjectOwnership.OBJECT_WRITER});
